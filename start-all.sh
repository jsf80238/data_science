...
4. update_model.py: subscribes to the Redis topic, updates the machine-learning model with the new data
"""

export PYTHONPATH="data_science:"
mkdir -p /tmp/stock_data
...
# 4.
python database/update_model.py &
